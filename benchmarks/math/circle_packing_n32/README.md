...
Pack 26 non-overlapping circles in a unit square to maximize the sum of their radii (AlphaEvolve B.12). Target: 2.937.

## Problem

- Pack exactly 32 circles inside a unit square
...
- **combined_score**: `sum_of_radii / 2.937` (ratio to AlphaEvolve target)
